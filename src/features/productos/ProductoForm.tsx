  ...
  const form = useForm({
    ...
    onSubmit: async ({ value }) => {
      ...
      if (imagenesFiles.length > 0) {
        ...
        const r = await fetch("http://localhost:8000/api/v1/uploads/imagen?carpeta=foodstore/productos", {
          method: "POST",
          credentials: "include",
          body: formData
        });
                  ...
                  <div>
                    ...
                    <div key={`existente-${index}`} className="relative">
                      ...
                      <button
                        ...
                        onClick={async () => {
                          if (img.public_id) {
                            await fetch(`http://localhost:8000/api/v1/uploads/imagen/${encodeURIComponent(img.public_id)}`, {
                              method: "DELETE",
                              credentials: "include",
                            });
                          }
