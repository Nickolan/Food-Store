        ...
        {loading ? (
          ...
          <div className="p-6">
            ...
            <h2 className="text-2xl font-bold text-stone-900 mb-1 flex items-center gap-2">
              ...
              {productoCompleto.tiene_alerta_precio && (
                <span
                  title="Precio de ingrediente actualizado"
                  className="inline-flex items-center gap-1 rounded-full bg-amber-100 text-amber-700 text-xs font-semibold px-2.5 py-0.5"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" className="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor">
                    <path fillRule="evenodd" d="M8.257 3.099c.765-1.36 2.722-1.36 3.486 0l5.58 9.92c.75 1.334-.213 2.98-1.742 2.98H4.42c-1.53 0-2.493-1.646-1.743-2.98l5.58-9.92zM11 13a1 1 0 11-2 0 1 1 0 012 0zm-1-8a1 1 0 00-1 1v3a1 1 0 002 0V6a1 1 0 00-1-1z" clipRule="evenodd" />
                  </svg>
                  Precio ingrediente actualizado
                </span>
              )}
            </h2>
